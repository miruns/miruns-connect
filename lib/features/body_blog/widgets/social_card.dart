...
///   • "MIRUNS" monogram + indigo dot top-left.
///   • Italic italic summary excerpt in warm cream.
///   • Tag pills at the bottom.
///   • "miruns ↗" watermark — subtle growth hook.
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  // ── Miruns masthead — sits above the data bar ─────────
                  Row(
...
class SocialCardCapture {
  ...
  static Future<void> _shareBytes(Uint8List bytes, BodyBlogEntry entry) async {
    ...
    final file = File('${dir.path}/miruns_share.png');
