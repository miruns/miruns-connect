                ...
                child: PageView(
                  ...
                  children: [
                    ...
                    _PermissionStep(
                      ...
                      body:
                          'Miruns uses your GPS coordinates to fetch local '
      ...
      child: Column(
        ...
        children: [
          ...
          _AndroidStep(
            number: '2',
            accent: accent,
            label: 'Open Health Connect → tap Miruns → allow data access',
          ),
        ],
      ),
    );
            ...
            child: Column(
              children: [
                ...
                _Phase2Row(
                  ...
                  sublabel: 'Tap Miruns → allow steps, heart rate, sleep…',
                ),
