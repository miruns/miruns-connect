...
/// The default Miruns Cloud provider works out of the box. Users can
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // ── Save default (if switching back to Miruns Cloud) ────────
          if (_draft.isDefault &&
              currentConfig.type != AiProviderType.mirunsCloud) ...[
            const SizedBox(height: 8),
            _ActionButton(
              label: 'Switch back to Miruns Cloud',
