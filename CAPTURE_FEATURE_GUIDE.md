...
The Capture feature is a comprehensive data collection system that serves as the foundation for AI-driven closed-loop feedback in Miruns. It captures multi-dimensional snapshots of the user's state, including health metrics, environmental conditions, location data, calendar context, and user reflections.
...
```dart
import 'package:miruns_flutter/core/services/capture_service.dart';
