...
![Version](https://img.shields.io/badge/version-1.0.34-informational)
...
| **Cloud Sync & Share**   | Sessions auto-sync to **miruns-link** (ephemeral backend) on save. Sync status indicator (syncing/synced/failed with retry). One-tap share generates a unique link (`https://share.miruns.com/{code}`) — copies to clipboard and opens native share sheet. Updates (tags, artifacts, notes) re-sync automatically. Anonymous device identity (no real device ID exposed).                                                                                                                                                                                                                                                                                                                                      |
